...
WebUI.verifyElementVisible(findTestObject('Feature Matter Create/span_Select a valid contact'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Feature Matter Create/button_Cancel'))
