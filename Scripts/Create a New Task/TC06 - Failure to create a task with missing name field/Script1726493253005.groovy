...
WebUI.verifyElementText(findTestObject('Feature New Task Created/span_This field is required'), 'This field is required.')

WebUI.click(findTestObject('Feature New Task Created/button_New task_close-modal-button'))
