...
WebUI.verifyElementText(findTestObject('Feature Company Created/span_This field is required'), 'This field is required.')

WebUI.click(findTestObject('Feature Company Created/button_Cancel'))
