...
WebUI.setText(findTestObject('Feature New Time Entry/input__userFieldAutocomplete_input'), 'Kosong')
...
WebUI.verifyElementVisible(findTestObject('Feature New Time Entry/span_Select a valid firm user'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Feature New Time Entry/button_New time entry_close-modal-button'))
